...
#include <Adafruit_MPU6050.h>
  ...
  Adafruit_MPU6050 mpu;
    ...
    bool mpuBegin() {
      ...
      mpu.setAccelerometerRange(MPU6050_RANGE_4_G); // estaba en 8_G
      mpu.setGyroRange(MPU6050_RANGE_250_DEG); // estaba en 500_DEG
    ...
    String datosEnString  = ( xA + "," + xI + "," + yA + "," + yI + "," + zA + "," + zI).c_str();
